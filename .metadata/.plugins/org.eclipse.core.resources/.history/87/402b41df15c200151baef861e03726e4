...
int count=0,count2=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //bu kýsým yazý þeklini istediðimiz gibi deðiþtirme yarar.
        face1=Typeface.createFromAsset(getAssets(), "fonts/horrendo.ttf");
        text.setTypeface(face1);
       //Gördüðünüz gibi setOnClickListener metodu TextView deðiþkenindede iþ görüyor. 
	...
	public void onClick(View v) {
		...
		case R.id.button2:
			if(count2%4==0){
				text.setRotation(90);
				b2.setText("Döndür þuan 90 derece");
				
			}
			else if(count2%4==1){
				text.setRotation(180);
				b2.setText("Döndür þuan 180 derece");
				
			}
			else if(count2%4==2){
				text.setRotation(270);
				b2.setText("Döndür þuan 270 derece");
				
			}
			else{
				text.setRotation(360);
				b2.setText("Döndür þuan ilk hali");
